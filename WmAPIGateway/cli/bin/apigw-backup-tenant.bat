...
SET CLASSPATH=%CURR_DIR%..\..\code\jars\snakeyaml-1.15.0.jar;%CLASSPATH%
SET CLASSPATH=%CURR_DIR%..\lib\log4j-api-2.11.1.jar;%CLASSPATH%
SET CLASSPATH=%CURR_DIR%..\lib\log4j-core-2.11.1.jar;%CLASSPATH%

%JAVA_EXE% com.softwareag.apigateway.utility.command.backup.instance.BackupApiGatewayForDisasterRecovery %*
